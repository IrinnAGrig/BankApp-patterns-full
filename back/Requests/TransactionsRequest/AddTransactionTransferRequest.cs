...
{
    public class AddTransactionT : IRequest<bool>
    {
        public TransactionTransferDto Data { get; set; }

        public AddTransactionT(TransactionTransferDto data)
        {
            Data = data ?? throw new ArgumentNullException(nameof(data));
        }

        internal class Handler : IRequestHandler<AddTransactionT, bool>
        {
            ...
            public async Task<bool> Handle(AddTransactionT request, CancellationToken cancellationToken)
            {
                    try
                    {
